...
class HourglassPlabicGraph:
    ...
    def get_trip(self, vertex, i):
        '''vertex: the initial boundary Vertex; assumes multiplicity 1
           ...
           Returns the list of HalfHourglasses the trip visits in order.'''
    ...
    def get_trip_perm(self, i):
        ''' Computes the ith trip permutation.
            ...
            Boundary vertices are assumed to be numbered 1, 2, ..., n CCW starting slightly east of due north.'''
        perm = []
