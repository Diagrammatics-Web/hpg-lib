...
def reduced_tests():
    ...
    # Reduced HPGs
    assert HourglassPlabicGraph.from_dict(Examples.example_ASM).is_fully_reduced(4, True), "example_ASM should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_5_by_2).is_fully_reduced(5, True), "example_5_by_2 should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_5_by_3_ASM).is_fully_reduced(5, True), "example_5_by_3_ASM should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_9_by_2).is_fully_reduced(9, True), "example_9_by_2 should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_2_column_running).is_fully_reduced(7, True), "example_2_column_running should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_2_column_running_after_squaremove).is_fully_reduced(7, True), "example_2_column_running_after_squaremove should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_2_column_running_ear_cut).is_fully_reduced(7, True), "example_2_column_running_ear_cut should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_benzene).is_fully_reduced(4, True), "example_benzene should be fully reduced."
    assert HourglassPlabicGraph.from_dict(Examples.example_double_crossing).is_fully_reduced(4, True), "example_double_crossing should be fully reduced."
    
    # Non-reduced HPGs
    assert not HourglassPlabicGraph.from_dict(Examples.example_benzene_full_nonreduced).is_fully_reduced(4, True), "example_benzene_full_nonreduced should not be fully reduced."
    assert not HourglassPlabicGraph.from_dict(Examples.example_5x4_badsep).is_fully_reduced(5, True), "example_5x4_badsep should not be fully reduced."

    # Test unknown examples
    print("Testing example_6_by_3 for reducedness.")
    print("example_6_by_3 is " + ("" if HourglassPlabicGraph.from_dict(Examples.example_6_by_3).is_fully_reduced(6, True) else "not ") + "fully reduced.")
    print("Testing example_6_by_3_bad for reducedness.")
    print("example_6_by_3_bad is " + ("" if HourglassPlabicGraph.from_dict(Examples.example_6_by_3_bad).is_fully_reduced(6, True) else "not ") + "fully reduced.")
    print("Testing example_6_by_6 for reducedness.")
    print("example_6_by_6 is " + ("" if HourglassPlabicGraph.from_dict(Examples.example_6_by_6).is_fully_reduced(6, True) else "not ") + "fully reduced.")
    print("Testing example_christian_is_working_with for reducedness.")
    print("example_christian_is_working_with is " + ("" if HourglassPlabicGraph.from_dict(Examples.example_christian_is_working_with).is_fully_reduced(4, True) else "not ") + "fully reduced.")
